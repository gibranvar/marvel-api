...
const marvel = {
  render: () => {
    const urlCharacterId = 'https://gateway.marvel.com:443/v1/public/comics/100731?ts=1&apikey=54d242a7bb0fbb74d3abf596dda41f2b&hash=7d5e2dcf861fd30bb6a5cfa9583c283c';
    const urlComicId = 'https://gateway.marvel.com:443/v1/public/comics/96852?ts=1&apikey=54d242a7bb0fbb74d3abf596dda41f2b&hash=7d5e2dcf861fd30bb6a5cfa9583c283c';
    const urlEventId = 'https://gateway.marvel.com:443/v1/public/events/323?ts=1&apikey=54d242a7bb0fbb74d3abf596dda41f2b&hash=7d5e2dcf861fd30bb6a5cfa9583c283c';
    ...
    fetch(urlCharacterId)
      ...
      .then((json) => {
        for (const comic of json.data.results) {
            ...
            let carouselInner = document.querySelector("#carusel-image") 
            ...
            /* let heroCapId = `${comic.description}`;
            let heroCap = document.querySelector("#carousel-capt");
             heroCap.append(heroCapId); */
        }
